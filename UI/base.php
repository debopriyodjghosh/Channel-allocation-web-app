...
if (isset($_POST)) {
    ...
    if ($conn->query($sql) === true) { ?>
        <script type="text/javascript">
            alert('Base Station & Devices Placed!');
...
<body >
    <div class="login">
        ...
        <button onclick="location.href='device.php'" type ="button" class="btn btn-block btn-danger" value=" ">Start Allocation</button>
    </td>
    </div>
    </div>
    <hr>
